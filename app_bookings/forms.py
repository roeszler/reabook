...
class BookingForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'date_of_viewing': forms.DateInput(attrs={'class':'form-control col-lg-12', 'rows': '3', 'max-rows': '6', }),
            'time_of_viewing': forms.TimeInput(attrs={'class':'form-control col-lg-12', 'rows': '3', 'max-rows': '6', }),
        }
