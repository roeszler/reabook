...
class Booking(models.Model):
    ...
    booking_number = models.CharField(max_length=256, null=False, editable=False, unique=True) # noqa
    user = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True) # noqa
    property_id = models.ForeignKey('app_properties.Property', null=True, blank=True, on_delete=models.SET_NULL) # noqa
    booking_name = models.CharField(max_length=254, null=True, blank=True, default='15 min Viewing') # noqa
    ...
    client_username = models.CharField(max_length=40, null=True, blank=True, default='Create Username') # noqa
    ...
    client_country = models.CharField(max_length=2, choices=pytz.country_names.items(), null=True, blank=True) # noqa
